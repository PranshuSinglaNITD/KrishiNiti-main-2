...
const SEASON_INFO: Record<string, { icon: string; months: string; color: string; desc: string }> = {
  "Kharif": { icon: "", months: "Jun–Oct", color: "#d4820a", desc: "Monsoon season crops — rice, cotton, maize" },
  "Rabi": { icon: "", months: "Nov–Apr", color: "#4a8ec2", desc: "Winter season crops — wheat, barley, mustard" },
  "Summer": { icon: "", months: "Apr–Jun", color: "#e07a3a", desc: "Hot season crops — watermelon, cucumber" },
  "Winter": { icon: "", months: "Nov–Feb", color: "#6ba3c4", desc: "Cold weather crops — peas, spinach" },
